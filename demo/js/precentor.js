  ...
  (function(document) {
    ...
    Precentor = (function() {
      ...
      Precentor.prototype.buildOpts = function() {
        var elDataSet, k, normalize, v, _results;
        ...
        for (k in elDataSet) {
          v = elDataSet[k];
          _results.push(normalize(k, v));
        }
        return _results;
      };

      Precentor.prototype.buildEls = function() {
        (this.target = dom.createElement('span')).className = 'precentor-target';
